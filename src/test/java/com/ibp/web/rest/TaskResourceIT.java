...
import com.ibp.domain.Task;
import com.ibp.repository.TaskRepository;
import com.ibp.service.TaskService;
...
import com.ibp.domain.enumeration.TypeTask;
/**
...
public class TaskResourceIT {
    ...
    private static final TypeTask DEFAULT_TYPE = TypeTask.PF;
    private static final TypeTask UPDATED_TYPE = TypeTask.WebApp;
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getNom()).isEqualTo(DEFAULT_NOM);
    ...
    public void updateTask() throws Exception {
        ...
        Task testTask = taskList.get(taskList.size() - 1);
        assertThat(testTask.getNom()).isEqualTo(UPDATED_NOM);
